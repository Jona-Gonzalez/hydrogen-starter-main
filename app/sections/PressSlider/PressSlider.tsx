...
import {PressSliderProps} from './PressSlider.types';
import {PressSliderThumb} from './PressSliderThumb';
import {Schema} from './PressSlider.schema';

export function PressSlider({cms}: {cms: PressSliderProps}) {
          ...
          <div className="mt-4 md:hidden">
            ...
            >
              {slides.map(({alt, image}, index) => {
                const isActive = index === activeIndex;
                return (
                  <SwiperSlide className="flex justify-center px-4" key={index}>
                    <PressSliderThumb
                      alt={alt}
                      image={image}
                      isActive={isActive}
