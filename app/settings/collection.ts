...
const usesColorGroups = {
  label: 'Uses Color Groups',
  name: 'usesColorGroups',
  component: 'toggle',
  toggleLabels: {
    true: 'On',
    false: 'Off',
...
export default {
  ...
  component: 'group',
  description:
    'Filters, in stock filter, sort, pagination, product item, promotion',
  fields: [
    {
      label: 'Filters',
      name: 'filters',
      component: 'group',
      description: 'Enable, custom filters, color groups, show option count',
      fields: [
        {
          label: 'Enable',
          name: 'enabled',
          ...
          fields: [
            {
              ...
              name: 'name',
              component: 'text',
              description: 'Name of the color group, e.g. "Blue"',
            },
            {
              label: 'Color Values',
              name: 'colors',
              ...
              description: 'e.g. "Blue", "Sky Blue", "Dark Blue"',
            },
          ],
        },
      ],
    },
    {
      ...
      fields: [
        {
          ...
          component: 'toggle',
          description:
            'Provides option to filter for products available for sale only.\n\nIf no filters are selected, only products with at least one available variant will be visible. If filters are selected, only products with an available variant matching the critera will be visible',
          toggleLabels: {
            true: 'On',
            false: 'Off',
          },
      ...
      defaultValue: {
        enabled: true,
        label: 'Show in stock results only',
      },
    },
    {
      label: 'Pagination',
      ...
      fields: [
        ...
        },
        {
          ...
          variant: 'radio',
          options: [
            {label: 'Load More Button', value: 'button'},
